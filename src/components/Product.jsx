...
const Product = ({ product }) => {
  ...
  return (
    <>
      ...
      <div className='flex flex-col justify-evenly w-full md:h-[543.338] max-w-sm bg-white border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700'>
