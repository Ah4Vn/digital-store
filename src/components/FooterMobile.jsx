...
function FooterMobile() {
  return (
    <>
      <footer className='w-full py-20 lg:hidden'>
            ...
            <div className='block lg:max-w-md'>
              ...
              <div className='lg:bg-gray-100 lg:rounded-full lg:h-16 lg:p-1.5 lg:flex-row gap-6 lg:gap-0 flex-col flex items-center justify-between'>
                <input
                  type='text'
                  name='email'
                  className='text-right py-3 px-6 bg-gray-100 rounded-full text-gray-900 placeholder:text-gray-500 focus:outline-none flex-1 w-full max-w-xl mx-auto lg:w-auto lg:py-5 lg:px-7 lg:bg-transparent'
