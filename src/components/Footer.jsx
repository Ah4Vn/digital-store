...
const Footer = () => {
  return (
    <>
      <div className='hidden footer-container lg:flex text-foreground dark:text-foreground-dark'>
        <div className='container mt-12 mx-auto px-2 md:px-32'>
          <section className='mb-20'>
            ...
            <div className='flex flex-wrap' dir='rtl'>
              <div className='mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-8 text-right'>
                <div className='flex lg:flex-1 lg:justify-start mb-6'>
                ...
                <h4 className='mb-4'>
                  مجموعه ای از چاپگرها و متون بلکه روزنامه و مجله
                </h4>
                ...
                <div className='flex flex-wrap'>
                  <div className='mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6'>
                    <div className='flex items-start'>
                      ...
                      <div className='ml-6 grow'>
                        <p className='mb-2 font-bold'>پشتیبانی فنی</p>
                  ...
                  <div className='mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6'>
                    <div className='flex items-start'>
                      ...
                      <div className='ml-6 grow'>
                        <p className='mb-2 font-bold '>سوالات فروش</p>
                  ...
                  <div className='mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6'>
                    <div className='align-start flex'>
                      ...
                      <div className='ml-6 grow'>
                        <p className='mb-2 font-bold'>گزارش مشکل</p>
